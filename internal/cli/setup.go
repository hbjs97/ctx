...
// setupTemplate is the default config.toml content generated by ctx setup.
...
func (a *App) runSetup() error {
	...
	fmt.Fprintf(os.Stdout, "설정 파일이 생성되었습니다: %s\n", a.CfgPath)
	fmt.Fprintln(os.Stdout, "프로필을 수정한 후 ctx doctor로 환경을 확인하세요.")
	return nil
}
